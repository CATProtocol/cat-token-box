...
import { contractSendNft as contractSend } from '../../../src/features/cat721/send/contractSend';
...
export async function singleSendNft(minterAddr: string, inputTokenUtxos: Cat721Utxo[], nftReceiverAddrs: Ripemd160[]) {
    return singleSend(
        testSigner,
        testUtxoProvider,
        testChainProvider,
...
export async function burnNft(minterAddr: string, inputTokenUtxos: Cat721Utxo[]) {
