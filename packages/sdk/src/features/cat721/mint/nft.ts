import { Postage } from '@cat-protocol/cat-sdk-v2';
...
export async function createNft(
  ...
  const nftCommitScript = getCatNFTCommitScript(catToXOnly(pubkey, isP2TR(address)), nftmetadata, contentBody ? {
    type: contentType,
    body: contentBody,
  } : undefined);
  ...
  psbt.spendUTXO(feeUtxos).addOutput(
    {
