...
export class Init1727071643783 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_86da4cbf17aa7cdc2ae2e1fc9b" ON "tx_out" ("owner_pkh") `);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_b957c010e5dc41997dbe432b5b" ON "tx_out" ("spend_txid") `);
    await queryRunner.query(
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_dda1249bcfce884c26070b1f96" ON "tx" ("block_height") `);
    await queryRunner.query(
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_bce676e2b005104ccb768495db" ON "block" ("height") `);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_530dcb59ea83d11c640dd31d99"`);
